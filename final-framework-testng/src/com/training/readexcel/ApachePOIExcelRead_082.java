 ...
 *      access.
 */
public class ApachePOIExcelRead_082 {
	...
	public static void main(String[] args) {
		...
		for(String [] temp : new ApachePOIExcelRead_082().getExcelContent(fileName, "Test Data",START_ROW, START_COL, TOTAL_ROWS, TOTAL_COLUMNS)){
			for(String  tt : temp){
				if (tt !=null) {
